...
SWIFT_CLASS("_TtC8Find_Kit11AppDelegate")
...
SWIFT_CLASS("_TtC8Find_Kit19MKActivityIndicator")
...
SWIFT_CLASS("_TtC8Find_Kit8MKButton")
...
SWIFT_CLASS("_TtC8Find_Kit10MKCardView")
...
SWIFT_CLASS("_TtC8Find_Kit20MKCollectionViewCell")
...
SWIFT_CLASS("_TtC8Find_Kit28MKEmbedDrawerControllerSegue")
...
SWIFT_CLASS("_TtC8Find_Kit26MKEmbedMainControllerSegue")
...
SWIFT_CLASS("_TtC8Find_Kit11MKImageView")
...
SWIFT_CLASS("_TtC8Find_Kit7MKLabel")
...
SWIFT_CLASS("_TtC8Find_Kit7MKLayer")
...
SWIFT_CLASS("_TtC8Find_Kit15MKNavigationBar")
...
SWIFT_CLASS("_TtC8Find_Kit16MKRefreshControl")
...
SWIFT_PROTOCOL("_TtP8Find_Kit30MKSideDrawerControllerDelegate_")
...
SWIFT_CLASS("_TtC8Find_Kit26MKSideDrawerViewController")
...
SWIFT_CLASS("_TtC8Find_Kit10MKSnackbar")
...
SWIFT_PROTOCOL("_TtP8Find_Kit18MKSnackbarDelegate_")
...
SWIFT_CLASS("_TtC8Find_Kit8MKSwitch")
...
SWIFT_CLASS("_TtC8Find_Kit13MKSwitchLayer")
...
SWIFT_CLASS("_TtC8Find_Kit15MKTableViewCell")
...
SWIFT_CLASS("_TtC8Find_Kit11MKTextField")
...
@interface MKTextField (SWIFT_EXTENSION(Find_Kit))
@end


SWIFT_CLASS("_TtC8Find_Kit10MainButton")
...
SWIFT_CLASS("_TtC8Find_Kit12MenuItemView")
...
@interface NSNumber (SWIFT_EXTENSION(Find_Kit))
@property (nonatomic, readonly) BOOL isBool;
@end

@class UITextView;

SWIFT_CLASS("_TtC8Find_Kit17RMAlertController")
...
@interface RMAlertController (SWIFT_EXTENSION(Find_Kit))
@end


SWIFT_CLASS("_TtC8Find_Kit14RMAudioManager")
@interface RMAudioManager : NSObject
+ (void)playSE:(NSString * _Nonnull)name type:(NSString * _Nonnull)type;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@protocol RMConnectionDelegate;

SWIFT_CLASS("_TtC8Find_Kit12RMConnection")
@interface RMConnection : NSObject
@property (nonatomic, strong) id <RMConnectionDelegate> _Nullable delegate;
...
SWIFT_PROTOCOL("_TtP8Find_Kit20RMConnectionDelegate_")
@protocol RMConnectionDelegate
@optional
...
SWIFT_CLASS("_TtC8Find_Kit16RMHorizontalMenu")
...
SWIFT_PROTOCOL("_TtP8Find_Kit24RMHorizontalMenuDelegate_")
@protocol RMHorizontalMenuDelegate
@optional
...
SWIFT_CLASS("_TtC8Find_Kit10RMMenuView")
...
@interface RMMenuView (SWIFT_EXTENSION(Find_Kit))
@end

@class RMTip;
@protocol UIViewControllerTransitionCoordinator;

SWIFT_CLASS("_TtC8Find_Kit22RMNavigationController")
...
SWIFT_CLASS("_TtC8Find_Kit14RMReachability")
...
SWIFT_CLASS("_TtC8Find_Kit5RMTip")
...
@interface UIColor (SWIFT_EXTENSION(Find_Kit))
...
@interface UIImage (SWIFT_EXTENSION(Find_Kit))
...
@interface UIImageView (SWIFT_EXTENSION(Find_Kit))
+ (UIImageView * _Nonnull)maskImage:(UIImage * _Nonnull)image maskImage:(UIImage * _Nonnull)maskImage;
@end


@interface UITextView (SWIFT_EXTENSION(Find_Kit))
- (void)_firstBaselineOffsetFromTop;
- (void)_baselineOffsetFromBottom;
@end


@interface UIView (SWIFT_EXTENSION(Find_Kit))
- (void)shadowLevel:(NSInteger)lv;
@end


@interface UIViewController (SWIFT_EXTENSION(Find_Kit))
...
SWIFT_CLASS("_TtC8Find_Kit14ViewController")
@interface ViewController : RMNavigationController <MKMapViewDelegate, CLLocationManagerDelegate, RMConnectionDelegate>
