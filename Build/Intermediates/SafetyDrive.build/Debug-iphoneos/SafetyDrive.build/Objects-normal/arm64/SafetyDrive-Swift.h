...
SWIFT_CLASS("_TtC11SafetyDrive11AppDelegate")
...
SWIFT_CLASS("_TtC11SafetyDrive19MKActivityIndicator")
...
SWIFT_CLASS("_TtC11SafetyDrive8MKButton")
...
SWIFT_CLASS("_TtC11SafetyDrive10MKCardView")
...
SWIFT_CLASS("_TtC11SafetyDrive20MKCollectionViewCell")
...
SWIFT_CLASS("_TtC11SafetyDrive28MKEmbedDrawerControllerSegue")
...
SWIFT_CLASS("_TtC11SafetyDrive26MKEmbedMainControllerSegue")
...
SWIFT_CLASS("_TtC11SafetyDrive11MKImageView")
...
SWIFT_CLASS("_TtC11SafetyDrive7MKLabel")
...
SWIFT_CLASS("_TtC11SafetyDrive7MKLayer")
...
SWIFT_CLASS("_TtC11SafetyDrive15MKNavigationBar")
...
SWIFT_CLASS("_TtC11SafetyDrive16MKRefreshControl")
...
SWIFT_PROTOCOL("_TtP11SafetyDrive30MKSideDrawerControllerDelegate_")
...
SWIFT_CLASS("_TtC11SafetyDrive26MKSideDrawerViewController")
...
SWIFT_CLASS("_TtC11SafetyDrive10MKSnackbar")
...
SWIFT_PROTOCOL("_TtP11SafetyDrive18MKSnackbarDelegate_")
...
SWIFT_CLASS("_TtC11SafetyDrive8MKSwitch")
...
SWIFT_CLASS("_TtC11SafetyDrive13MKSwitchLayer")
...
SWIFT_CLASS("_TtC11SafetyDrive15MKTableViewCell")
...
SWIFT_CLASS("_TtC11SafetyDrive11MKTextField")
...
@interface MKTextField (SWIFT_EXTENSION(SafetyDrive))
@end

@class NSString;

SWIFT_CLASS("_TtC11SafetyDrive12MenuItemView")
...
@interface NSNumber (SWIFT_EXTENSION(SafetyDrive))
@property (nonatomic, readonly) BOOL isBool;
@end


SWIFT_CLASS("_TtC11SafetyDrive24PagingCellViewController")
...
SWIFT_CLASS("_TtC11SafetyDrive20PagingDataController")
...
SWIFT_CLASS("_TtC11SafetyDrive22RMNavigationController")
...
@property (nonatomic, strong) UIView * _Nonnull navigationBar;
...
SWIFT_CLASS("_TtC11SafetyDrive20PagingViewController")
...
SWIFT_CLASS("_TtC11SafetyDrive17RMAlertController")
...
@interface RMAlertController (SWIFT_EXTENSION(SafetyDrive))
...
SWIFT_CLASS("_TtC11SafetyDrive16RMHorizontalMenu")
...
SWIFT_PROTOCOL("_TtP11SafetyDrive24RMHorizontalMenuDelegate_")
@protocol RMHorizontalMenuDelegate
@optional
...
SWIFT_CLASS("_TtC11SafetyDrive10RMMenuView")
...
@interface RMMenuView (SWIFT_EXTENSION(SafetyDrive))
@end


@class NSNotificationCenter;

SWIFT_CLASS("_TtC11SafetyDrive14RMReachability")
...
SWIFT_CLASS("_TtC11SafetyDrive5RMTip")
...
@interface UIColor (SWIFT_EXTENSION(SafetyDrive))
...
@interface UIImage (SWIFT_EXTENSION(SafetyDrive))
...
@interface UIImageView (SWIFT_EXTENSION(SafetyDrive))
+ (UIImageView * _Nonnull)maskImage:(UIImage * _Nonnull)image maskImage:(UIImage * _Nonnull)maskImage;
@end


@interface UITextView (SWIFT_EXTENSION(SafetyDrive))
- (void)_firstBaselineOffsetFromTop;
- (void)_baselineOffsetFromBottom;
@end


@interface UIViewController (SWIFT_EXTENSION(SafetyDrive))
...
SWIFT_CLASS("_TtC11SafetyDrive14ViewController")
@interface ViewController : RMNavigationController
- (void)viewDidLoad;
